package Module2.RoadController;
/*
 * Задание 1:
 * Уменьшить высоту пропускного пункта до 3,5 метра
 *
 * Задание 2:
 * Исправить в этом коде ошибку, поскольку выставляется неверно цена за грузовые и легковые
 * автомобили
 */
import Module2.RoadController.core.*;
import Module2.RoadController.core.Camera;
